...
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <? if (payment_method == 'Pago con tarjetas de Credito/Debito' ){?>
      <div class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-title"><i class="fa fa-info-circle"></i> Metodo de pago</h3>
        </div>
        <div class="panel-body">
          <table class="table table-bordered">
            <thead>
              <tr>
                <td style="width: 50%;" class="text-left">Informac&iacute;on de pago con tarjeta banregio</td>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td class="text-left">
                  Referencia: <?php echo $payment_address; ?> <br>
                  Codigo de respuesta: <?php echo $payment_address; ?> <br>
                  Codigo de Autorizaci&oacute;n: <?php echo $payment_address; ?> <br>
                  Folio: <?php echo $payment_address; ?> <br>
                  Fecha: <?php echo $payment_address; ?> <br>
                </td>
              </tr>
            </tbody>
          </table>
